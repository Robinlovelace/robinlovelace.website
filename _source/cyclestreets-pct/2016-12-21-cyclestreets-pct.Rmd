...
```{r, echo=FALSE}
knitr::include_graphics("figures/regions1.png")
```
...
knitr::include_graphics(c("figures/regions2.png", "figures/regions3.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics("figures/west-yorkshire-front.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("figures/leeds-desire-godutch.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/home/robin/npct/pct/flow-model/od-data-fast-quiet.png")
```
