...
```{r, echo=FALSE}
knitr::include_graphics("/home/robin/npct/pct/figures/regions1.png")
```
...
knitr::include_graphics(c("/home/robin/npct/pct/figures/regions2.png", "/home/robin/npct/pct/figures/regions3.png"))
```
...
```{r, echo=FALSE}
knitr::include_graphics("/home/robin/npct/pct/figures/west-yorkshire-front.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/home/robin/npct/pct/flow-model/od-data-leeds.png")
```

```{r, echo=FALSE}
knitr::include_graphics("/home/robin/npct/pct/figures/leeds-desire-godutch.png")
```
