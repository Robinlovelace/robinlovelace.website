...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/figures/regions1.png?raw=true")
```
...
knitr::include_graphics(c("https://github.com/npct/pct/blob/master/figures/regions2.png?raw=true", "https://github.com/npct/pct/blob/master/figures/regions3.png?raw=true"))
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/figures/west-yorkshire-front.png?raw=true")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/flow-model/od-data-leeds.png?raw=true")
```

```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/figures/leeds-desire-godutch.png?raw=true")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/flow-model/od-data-fast-quiet.png?raw=true")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://github.com/npct/pct/blob/master/figures/pct-vs-strava-for-leeds.png?raw=true")
```
