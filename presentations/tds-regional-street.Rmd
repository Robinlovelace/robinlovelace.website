...
system.time({
  lvn_lines = readRDS("belgium_cycleway.Rds")
})
...
1. Work through an introduction to road safety analysis with R: https://docs.ropensci.org/stats19/articles/stats19-training.html

2. Work through the Transport Chapter (12) in Geocompuation with R

3. Apply the methods in that chapter to a differen UK city (advanced)
